        ...
        <div className="w-full max-w-md">
          <div className="bg-card rounded-2xl shadow-xl p-8 border border-border">
            ...
            <div className="text-center mb-8">
              <div className="metallic inline-flex items-center justify-center w-16 h-16 rounded-full mb-4 bg-blue-metallic">
              ...
              <div className="mt-3 px-3 py-1 rounded-lg inline-block bg-accent-foreground/30 backdrop-blur-3xl  bg-clip-padding">
              ...
              <div className="flex justify-center space-x-3 mb-6">
                {otp.map((digit, index) => (
                  <input
                    ...
                    ${digit ? "border-blue text-foreground" : "bg-background"}
            ...
            <div className="space-y-4">
              <button
                ...
                disabled={isVerifying}
                className="
                metallic w-full flex items-center justify-center space-x-2 px-4 py-3 
                text-white rounded-lg transition-all duration-200 font-medium text-sm
                disabled:opacity-50 disabled:cursor-not-allowed
                hover:scale-105 active:scale-95 bg-blue-metallic
              "
              >
